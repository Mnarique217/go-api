...
package cr.una.timetrackingapp.backend.error;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handlePriorityNotFound(final TimeSheetNotFoundException ex, final WebRequest request) {
        logger.info(ex.getClass().getName());
        logger.error("cr/una/timetrackingapp/backend/error", ex);
        //
